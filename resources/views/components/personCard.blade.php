...
<div class=" text-white flex flex-col items-center justify-center gap-3 m-16">
    <h1>Benvenuto/a nell'area Kidults.</h1>

<div class="md:flex flex-row mt-20">
    <div class="flex flex-col items-center font-bold lg:ml-60 ">
        ...
        <span class="-translate-y-8 text-center font-semibold text-xl text-black tracking-wider">6666691003559</span>
        ...
        <span >
            <svg viewBox="0 0 192 192" xmlns="http://www.w3.org/2000/svg" class="w-12 ml-4" fill="none">
                <g id="SVGRepo_bgCarrier" stroke-width="6"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round"
                 stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"><path stroke="#000000" stroke-linecap="round" 
                    stroke-linejoin="round" stroke-width="14" d="m79.756 48.376-11.86-11.86L22 82.41l27.331 27.331L123.073 36 170 82.927l-73.742 73.742-27.331-27.331"></path>
                    <circle cx="124" cy="82" r="12" fill="#000000"></circle></g></svg>
        </span>
        <div ><span class="text-sm font-bold">Salva con</span> <h4 class="font-bold text-2xl leading-3">Stocard</h4> 
        </div>
...
<div class="mt-8 w-44 h-[400px] md:flex hidden">   
     <svg  viewBox="4 1 14 28"  fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <g id="Interface / Line_Xl"> <path id="Vector" d="M12 21V3" stroke="#ffffff" stroke-width="0.192" stroke-linecap="round" stroke-linejoin="round"></path> </g> </g></svg>
</div>

<div class="flex flex-col ">
    <p class="font-semibold lg:self-start self-center lg:m-0 m-8">Cosa puoi fare adesso?</p>
    ...
    <div class="bg-[#e6e6e9] flex  w-32 h-24 justify-center  items-center rounded-xl ">
       ...
       <div class="md:flex hidden flex-col  md:mx-3 md:items-start items-center my-3 w-[70%] md:w-[50%] ">
        <h5 class="md:text-start text-center">1€ DI SPESA = 1 PUNTO!</h5>
        <p >Acquista online o presso i negozi aderenti all'iniziativa Toys Center e Bimbostore.</p>
       </div>

       <div class="md:hidden flex flex-col  items-center my-4 w-[70%]">
        <h5 class="text-center">1€ DI SPESA = 1 PUNTO!</h5>
        <p class="text-center">Acquista online o presso i negozi aderenti all'iniziativa Toys Center e Bimbostore.</p>
       </div>
    </div>
    ...
    <div class="flex md:flex-row flex-col items-center">
        <div class="bg-[#e6e6e9] flex  w-32 h-24 justify-center  items-center rounded-xl ">
           ...
           <div class="flex justify-center text-[9px] rotate-[22deg] translate-x-16  ">
            ...
            <svg class="w-20 h-16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M11.2691 4.41115C11.5006 3.89177 11.6164 3.63208 11.7776 3.55211C11.9176 3.48263 12.082 3.48263 12.222 3.55211C12.3832 3.63208 12.499 3.89177 12.7305 4.41115L14.5745 8.54808C14.643 8.70162 14.6772 8.77839 14.7302 8.83718C14.777 8.8892 14.8343 8.93081 14.8982 8.95929C14.9705 8.99149 15.0541 9.00031 15.2213 9.01795L19.7256 9.49336C20.2911 9.55304 20.5738 9.58288 20.6997 9.71147C20.809 9.82316 20.8598 9.97956 20.837 10.1342C20.8108 10.3122 20.5996 10.5025 20.1772 10.8832L16.8125 13.9154C16.6877 14.0279 16.6252 14.0842 16.5857 14.1527C16.5507 14.2134 16.5288 14.2807 16.5215 14.3503C16.5132 14.429 16.5306 14.5112 16.5655 14.6757L17.5053 19.1064C17.6233 19.6627 17.6823 19.9408 17.5989 20.1002C17.5264 20.2388 17.3934 20.3354 17.2393 20.3615C17.0619 20.3915 16.8156 20.2495 16.323 19.9654L12.3995 17.7024C12.2539 17.6184 12.1811 17.5765 12.1037 17.56C12.0352 17.5455 11.9644 17.5455 11.8959 17.56C11.8185 17.5765 11.7457 17.6184 11.6001 17.7024L7.67662 19.9654C7.18404 20.2495 6.93775 20.3915 6.76034 20.3615C6.60623 20.3354 6.47319 20.2388 6.40075 20.1002C6.31736 19.9408 6.37635 19.6627 6.49434 19.1064L7.4341 14.6757C7.46898 14.5112 7.48642 14.429 7.47814 14.3503C7.47081 14.2807 7.44894 14.2134 7.41394 14.1527C7.37439 14.0842 7.31195 14.0279 7.18708 13.9154L3.82246 10.8832C3.40005 10.5025 3.18884 10.3122 3.16258 10.1342C3.13978 9.97956 3.19059 9.82316 3.29993 9.71147C3.42581 9.58288 3.70856 9.55304 4.27406 9.49336L8.77835 9.01795C8.94553 9.00031 9.02911 8.99149 9.10139 8.95929C9.16534 8.93081 9.2226 8.8892 9.26946 8.83718C9.32241 8.77839 9.35663 8.70162 9.42508 8.54808L11.2691 4.41115Z" stroke="#fab600" stroke-width="1.176" stroke-linecap="round" stroke-linejoin="round" fill="#fab600"></path> </g></svg>
            <span class="text-white -translate-x-12 translate-y-7">300pt</span>
           </div>

           <div class="-translate-x-[70px]">
            <svg class="w-20 h-12 rotate-[24deg]" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 512 512" xml:space="preserve" fill="#000000"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <g> <path style="fill:#0f73bd;" d="M100.512,100.512L100.512,100.512c0-12.575,10.193-22.768,22.768-22.768h265.44 c12.575,0,22.768,10.193,22.768,22.768l0,0c0,12.575-10.193,22.768-22.768,22.768H123.28 C110.705,123.28,100.512,113.086,100.512,100.512z"></path> <path style="fill:#0f73bd;" d="M100.512,256.555L100.512,256.555c0-12.575,10.193-22.768,22.768-22.768h265.44 c12.575,0,22.768,10.193,22.768,22.768l0,0c0,12.575-10.193,22.768-22.768,22.768H123.28 C110.705,279.323,100.512,269.13,100.512,256.555z"></path> <path style="fill:#0f73bd;" d="M100.512,410.933L100.512,410.933c0-12.575,10.193-22.768,22.768-22.768h265.44 c12.575,0,22.768,10.193,22.768,22.768l0,0c0,12.575-10.193,22.768-22.768,22.768H123.28 C110.705,433.701,100.512,423.507,100.512,410.933z"></path> </g> <g> <path style="fill:#0f73bd;" d="M157.153,100.512L157.153,100.512c0-12.575,10.193-22.768,22.768-22.768H123.28 c-12.575,0-22.768,10.193-22.768,22.768l0,0c0,12.575,10.193,22.768,22.768,22.768h56.641 C167.346,123.28,157.153,113.086,157.153,100.512z"></path> <path style="fill:#0f73bd;" d="M157.153,256.555L157.153,256.555c0-12.575,10.193-22.768,22.768-22.768H123.28 c-12.575,0-22.768,10.193-22.768,22.768l0,0c0,12.575,10.193,22.768,22.768,22.768h56.641 C167.346,279.323,157.153,269.13,157.153,256.555z"></path> <path style="fill:#0f73bd;" d="M157.153,410.933L157.153,410.933c0-12.575,10.193-22.768,22.768-22.768H123.28 c-12.575,0-22.768,10.193-22.768,22.768l0,0c0,12.575,10.193,22.768,22.768,22.768h56.641 C167.346,433.701,157.153,423.507,157.153,410.933z"></path> </g> <g> <path style="fill:#0f73bd;" d="M411.488,512c-12.555,0-22.768-10.213-22.768-22.768V22.768C388.72,10.213,398.934,0,411.488,0 s22.768,10.213,22.768,22.768v466.464C434.256,501.787,424.043,512,411.488,512z"></path> <path style="fill:#0f73bd;" d="M100.512,512c-12.555,0-22.768-10.213-22.768-22.768V22.768C77.744,10.213,87.957,0,100.512,0 s22.768,10.213,22.768,22.768v466.464C123.28,501.787,113.066,512,100.512,512z"></path> </g> <g> <path style="fill:#0f73bd;" d="M416.486,489.232V22.768c0-7.327,3.493-13.837,8.885-18.004C421.524,1.789,416.716,0,411.488,0 c-12.555,0-22.768,10.213-22.768,22.768v466.464c0,12.555,10.213,22.768,22.768,22.768c5.228,0,10.036-1.789,13.883-4.763 C419.979,503.069,416.486,496.559,416.486,489.232z"></path> <path style="fill:#0f73bd;" d="M105.51,489.232V22.768c0-7.327,3.493-13.837,8.885-18.004C110.548,1.789,105.74,0,100.512,0 C87.957,0,77.744,10.213,77.744,22.768v466.464c0,12.555,10.213,22.768,22.768,22.768c5.228,0,10.036-1.789,13.883-4.763 C109.003,503.069,105.51,496.559,105.51,489.232z"></path> </g> </g></svg>
         </div>
        </div>
           <div class="md:flex hidden flex-col mx-3 items-start my-2 w-[50%] ">
...
<div class="m-12">
<x-button.button>ACCEDI</x-button.button>
