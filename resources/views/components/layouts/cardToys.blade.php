...
<div class="flex flex-col items-center bg-white rounded-3xl rounded-b-none md:rounded-b-3xl md:rounded-br-none md:rounded-e-none  pt-8 md:pt-4 md:p-12 space-y-2">
...
<x-layouts.check-toggles class="w-[90%] mx-auto"/>

<div class="flex flex-col space-y-3 ">
  <div class="self-center mt-4">   
     <x-button.button class="py-2 px-8 text-2xl ">CONFERMA</x-button.button>
  </div>
