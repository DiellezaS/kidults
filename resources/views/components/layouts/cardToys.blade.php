...
<div class="absolute lg:inset-10 inset-0" >
<div class=" md:p-6 max-w-md  m-3 lg:flex flex-row md:max-w-6xl relative mx-auto ">


<div class="flex flex-col w-full items-center bg-white rounded-3xl rounded-b-none lg:rounded-b-3xl lg:rounded-br-none lg:rounded-e-none lg:pt-6 pt-12 lg:p-6 space-y-4">
<h2 class="text-[#f34551]  md:text-3xl text-[23px] font-bold ">Possiedi già una Card Toys Center</h2>
<h5 class="text-[#f34551] text-lg md:text-xl font-family font-semibold tracking-wide">Prima di procedere...</h5>
<p class="md:w-[72%] w-[78%] text-center tracking-wide md:tracking-tight leading-5 text-base md:text-[15px] font-medium">Seleziona qui sotto le aree di tuo interesse per ricevere offerte in linea con le tue preferenze.</p>

<x-layouts.check-toggles class="w-[540px] mx-auto"/>

<div class="flex flex-col space-y-3 ">
  <div class="self-center mt-4">   
     <x-button.button class="py-2 px-8 text-2xl font-family">CONFERMA</x-button.button>
  </div>
   
<a href="#" class="self-center lg:mb-0 mb-2 text-black text-sm font-medium  underline">Annulla</a>
<p class="self-center lg:w-full lg:mb-0 mb-2 text-center w-[75%] text-base lg:text-sm font-family font-medium">Riceverai una mail di conferma all'indirizzo test@example.it</p>

</div>
</div>


<div class="flex flex-col rounded-3xl lg:rounded-s-none lg:rounded-tr-3xl rounded-t-none  bg-[#e6e6e9] justify-center w-full lg:w-[80%] font-family">
    <h4 class="self-center mt-10 text-lg font-bold font-family mb-4">Cosa cambia?</h4>
    <div class="leading-5  w-[75%] font-medium lg:mx-10 tracking-wide ">
