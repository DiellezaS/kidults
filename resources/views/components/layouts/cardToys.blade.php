...
<div class=" md:p-6 lg:p-0 max-w-md  m-7 lg:flex flex-row md:max-w-6xl relative mx-auto ">


<div class="flex flex-col w-full lg:h-[92%] items-center bg-white rounded-3xl rounded-b-none lg:rounded-b-3xl lg:rounded-br-none lg:rounded-e-none lg:pt-6 lg:p-6 pt-12  space-y-4">
...
<x-layouts.check-toggles class="mx-auto"/>
